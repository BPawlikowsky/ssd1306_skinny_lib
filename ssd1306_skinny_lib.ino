...
void loop() {
  ...
  // printStringToBuffer(testText, buffer, 128, x, 0, 1);
  // printStringToBuffer(testText, buffer, 128, x, 0, 2);
  // printStringToBuffer(testText, buffer, 128, x, 0, 3);
  // printStringToBuffer(testText, buffer, 128, x, 0, 4);
  // printStringToBuffer(testText, buffer, 128, x, 0, 5);
  // printStringToBuffer(testText, buffer, 128, x, 0, 6);
  // printStringToBuffer(testText, buffer, 128, x, 0, 7);
  // printStringToBuffer(testText, buffer, 128, x, 0, 8);

  // FPS counter
  printStringToBuffer(fpsString, buffer, 128, 5, 0, 8);
  ...
  sprintf(fpsString, "%0.2ffps", (1000000 / (end - start)));
}
